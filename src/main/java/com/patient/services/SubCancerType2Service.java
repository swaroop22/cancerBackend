...
public class SubCancerType2Service {
    ...
    public SubCancerType2 addOrUpdateSubCancerType2(String payLoad) throws JsonParseException, JsonMappingException, IOException {
        ...
        SubCancerType2 subCancerType1 = new SubCancerType2();
        subCancerType1.setId((int)(subCancerType2Repository.getMaxId() +1));
        subCancerType1.setTitle(subCancerType2.getTitle());
        subCancerType1.setSubcancertypeid(id);
